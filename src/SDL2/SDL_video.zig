...
pub fn SDL_WINDOWPOS_UNDEFINED_DISPLAY(x: u32) u32
{
    return (SDL_WINDOWPOS_UNDEFINED_MASK | x);
}
pub const SDL_WINDOWPOS_UNDEFINED: u32 = SDL_WINDOWPOS_UNDEFINED_DISPLAY(0);
pub fn SDL_WINDOWPOS_ISUNDEFINED(x: u32) bool
{
...
pub fn SDL_WINDOWPOS_CENTERED_DISPLAY(x) u32 
{
    return (SDL_WINDOWPOS_CENTERED_MASK | x);
}
pub const SDL_WINDOWPOS_CENTERED =   SDL_WINDOWPOS_CENTERED_DISPLAY(0);

pub fn SDL_WINDOWPOS_ISCENTERED(X) bool
{
